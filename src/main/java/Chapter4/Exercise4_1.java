 ...
 * @author kshan
 */
public class Exercise4_1 extends JFrame implements GLEventListener {
...
// build model matrix
    ...
    double timeFactor = (double) (System.currentTimeMillis() / 10);
    mMat.rotate(timeFactor, timeFactor, timeFactor);
...
// adjust OpenGL settings and draw model
  ...
  private void setupVertices() {
    GL4 gl = (GL4) GLContext.getCurrentGL();
// 24 vertices of the 8 triangles making up a prism
