...
public class Program4_2 extends JFrame implements GLEventListener {
  ...
  public void init(GLAutoDrawable drawable) {
    ...
    pMat = perspective(110.0f, aspect, 0.1f, 1000.0f);
  }
...
// build model matrix
    ...
    double timeFactor = (double) System.currentTimeMillis()%3600000 / 10000.0f;
      mMat.translate(Math.sin(2 * timeFactor) * 2.0, Math.sin(3 * timeFactor) * 2.0, Math.sin(4 * timeFactor) * 2.0);
      mMat.rotate(1000 * timeFactor, 1000 * timeFactor, 1000 * timeFactor);
...
// 36 vertices of the 12 triangles making up a 2 x 2 x 2 cube centered    at the origin
  ...
  private int createShaderProgram() {
    ...
    GL4 gl = (GL4) GLContext.getCurrentGL();
    String[] vshaderSource = readShaderSource("Chapter4/P4_2_2vertex.shader");
