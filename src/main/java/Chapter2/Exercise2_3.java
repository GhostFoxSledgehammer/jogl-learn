 ...
 * @author kshan
 */
public class Exercise2_3 extends JFrame implements GLEventListener {
  ...
  private int createShaderProgram() {
    ...
    GL4 gl = (GL4) GLContext.getCurrentGL();
    String[] vshaderSource = readShaderSource("Chapter2/E2_3vertex.shader");
